...
@section('content')
    <div class="container mt-lg-4 mb-lg-3">
        <div class="row bg-info rounded px-3 py-3 w-100">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('dashboard') }}" class="btn btn-md btn-secondary fw-bold my-auto me-1">lihat profile</a>
                        <a href="{{ route('products.import.show') }}" class="btn btn-md btn-success fw-bold my-auto me-1">Import Produk</a>
            ...
            <!-- Search form -->
            <form action="{{ route('dashboard.products') }}" method="GET" class="mb-3">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search product..." name="search" size="20">
